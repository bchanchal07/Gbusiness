...
import kotlinx.android.synthetic.main.recyclerview_item_social_media_icons.view.*

class SocialMediaIconsAdaptor(
    val mCtx: Context, var listner: SocialMediaAdaptorClick,
    private val socialList: List<SocialMediaData>,
) : RecyclerView.Adapter<SocialMediaIconsAdaptor.MyViewHolder>() {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.recyclerview_item_social_media_icons, parent, false);
    ...
    class MyViewHolder(var view: View) : RecyclerView.ViewHolder(view) {
        val title = view.tvSocialMediaIconName!!
        val image = view.ivSocialImageIcon!!
