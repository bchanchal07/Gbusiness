...
interface ApiCall {
    ...
    fun createBusinessListData(
        ...
        @Part("user_id") user_id: RequestBody,
        @Part("business_name") business_name: RequestBody,
        @Part("sub_domain") sub_domain: RequestBody,
        @Part imageFile: MultipartBody.Part,
        @Part("b_email") b_email: RequestBody,
        @Part("b_phone") b_phone: RequestBody,
        @Part("business_web_url") business_web_url: RequestBody,
        @Part("category") category: RequestBody,
        @Part("sub_category") sub_category: RequestBody,
        ...
        @Part("seller_url") seller_url: RequestBody,
        @Part("facebook_url") facebook_url: RequestBody,
        @Part("twitter_url") twitter_url: RequestBody,
        @Part("instagram_url") instagram_url: RequestBody,
        @Part("linkedin_url") linkedin_url: RequestBody,
        @Part("b_about_us") b_about_us: RequestBody,
    ): Call<BusinessListEditResponse>
