...
//            holder.textViewSpinnerItem.setTypeface(holder.textViewSpinnerItem.typeface, Typeface.BOLD)
            holder.textViewSpinnerItem.background = colorDrawable
        } /*else {
            holder.textViewSpinnerItem.setTypeface(holder.textViewSpinnerItem.typeface, Typeface.NORMAL)
        }*/
